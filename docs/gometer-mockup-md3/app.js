/* ===== GoMeter · логика мокапа (минимализм LocalSend) ===== */
...
const tabFor = { usage: "usage", key: "usage", settings: "settings", about: "settings" };
...
/* онбординг: старт без ключа невозможен — нужен ключ */
